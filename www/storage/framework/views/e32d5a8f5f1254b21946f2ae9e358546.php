...
<body>
    ...
    <?php endif; ?>
    <?php if(session("Algo Fallo")): ?>
        <div class="alert alert-danger"><?php echo e(session("Algo Fallo")); ?></div>
    <?php endif; ?>
            ...
            <tbody class="table-group-divider">
                <?php $__currentLoopData = $datos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e($item->Contraseña); ?></td>
                        <td>
                            ...
                            <a href="<?php echo e(route("crud.delete",$item->id)); ?>" onclick="return res()" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash"></i></a>
                        </td>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="<?php echo e(route("crud.update")); ?>" method="post">
                                        ...
                                        <div class="mb-3">
                                          <label for="exampleInputEmail1" class="form-label">ID</label>
                                          <input type="Text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="txtid" value="<?php echo e($item->id); ?>" readonly>
                                        </div>
                                        <div class="mb-3">
                                            <label for="exampleInputEmail1" class="form-label">Nombre</label>
                                            <input type="Text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="txtnombre" value="<?php echo e($item->Nombre); ?>">
                                        </div>
                                        <div class="mb-3">
                                            <label for="exampleInputEmail1" class="form-label">Apellidos</label>
                                            <input type="Text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="txtapellidos">
...
</html><?php /**PATH C:\laragon\www\crud\resources\views/welcome.blade.php ENDPATH**/ ?>